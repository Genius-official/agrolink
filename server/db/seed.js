...
const DEMO_USERS = async () => {
  ...
  return [
    ...
    },
    {
      ...
      joined: 'Feb 2026',
      bio: 'Wholesale buyer for Accra Fresh Market.',
      createdAt: new Date().toISOString(),
    },
    {
      id: 'buyer-002',
      ...
      password: buyerHash,
      role: 'buyer',
      avatar: 'https://ui-avatars.com/api/?name=Retail+Buyers&background=F4C430&color=1C3322',
      joined: 'Feb 2026',
      bio: 'Retail distribution company.',
      createdAt: new Date().toISOString(),
    },
  ];
};
